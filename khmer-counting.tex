...
\centerline{\includegraphics[width=5in]{./figure/time_benchmark.pdf}
...
\centerline{\includegraphics[width=5in]{./figure/memory_benchmark.pdf}}
...
\centerline{\includegraphics[width=5in]{./figure/disk_benchmark.pdf}}
...
\centerline{\includegraphics[width=5in]{./figure/count_benchmark.pdf}}
...
\centerline{\includegraphics[width=5in]{./figure/average_offset_vs_fpr.pdf}}
...
\centerline{\includegraphics[width=5in]{./figure/percent_offset_vs_fpr.pdf}}
...
\centerline{\includegraphics[width=5in]{./figure/perc_unique_pos.pdf}}
